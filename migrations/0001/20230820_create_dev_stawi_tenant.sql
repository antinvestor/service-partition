...
INSERT INTO partitions (id, tenant_id, partition_id, name, description, properties)
    VALUES('9bsv0s0hijjg02qks6i0', '9bsv0s0hijjg02qks6dg', '9bsv0s0hijjg02qks6i0',
           ...
           '{"scope": "openid offline offline_access profile contact", "audience": ["service_chat_engine", "service_profile", "service_stawi_api", "service_files"], ' ||
           '"logo_uri": "https://static.stawi.io/logo.png", "redirect_uris": ["https://app-dev.stawi.io/callback.html"]}');
